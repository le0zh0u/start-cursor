...
export const TweetBody = ({ tweet }: { tweet: EnrichedTweet }) => (
  <div className="break-words leading-normal tracking-tighter transition duration-200 group-hover/bento:translate-x-2">
...
export const MagicTweet = ({
  ...
  return (
    <div
      className={cn(
        "group/bento relative flex size-full max-w-lg flex-col gap-2 overflow-hidden rounded-lg border border-transparent p-4 shadow-sm shadow-input transition duration-200 hover:shadow-xl",
        className,
      )}
      {...props}
    >
